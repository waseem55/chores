...
void lcd_init(void)
{
    ...
    _delay((unsigned long)((15)*(31000/4000.0)));
...
void lcd_cmd(unsigned char c)
{
    ...
    PORTA = ((PORTA & 0xf0) | (0xf0 & c) >> 4);
    enable();

    PORTA = (PORTA & 0xf0) | (0x0f & c);
    enable();
    _delay((unsigned long)((5)*(31000/4000.0)));
}
...
void lcd_data(unsigned char d)
{
    ...
    PORTA = ((PORTA & 0xf0) | (0xf0 & d) >> 4);
    enable();

    PORTA = (PORTA & 0xf0) | (0x0f & d);
    enable();
